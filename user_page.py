...
def add_book(username):
    ...
    for info in hall_info:
        if info["Hall pax"] > max_pax:
            max_pax = info["Hall pax"]
    ...
    while True:
        ...
        if not check_crush(valid_date, end, hall_id):
...
def delete_book(username):
    ...
    if not have:
        print("\n Sorry, you don't have any booking yet!")
        return
        ...
        for index, info in enumerate(booking_info):
            ...
            if info["Booking ID"] == booking_id and info["Username"] == username:
                ...
                while True:
                    ...
                    check = check.lower()
                    if check == "yes":
                        print("\n""The booking information is deleted!")
                        ...
                        print("The information is not deleted""\n")
                        break
                    elif check == "back":
    ...
    for data in user_info:
        while data['Username'] == username:
            ...
            while True:
                ...
                if user_perform == "1":
                    data["First Name"] = input("Enter your first name: ").title()
                    break

                # Change their last name
                elif user_perform == "2":
                    data["Last Name"] = input("Enter your last name: ").title()
                    break
